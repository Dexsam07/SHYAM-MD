...
const phoneNumber = config.pairingNumber || config.ownerNumber || "917384287404";
...
global.botname = config.botName || "SHYAM-MD";
global.themeemoji = "•";
    ...
    try {
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (config.pairingNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 91001234567 (without + or spaces) : `)));
            }
            else {
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection === "open") {
                ...
                printLog('info', `[ ${config.botName || 'SHYAM-MD'} ]`);
