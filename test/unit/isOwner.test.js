...
vi.mock('../../config.js', () => ({
    default: { ownerNumber: '917384287404@s.whatsapp.net' }
}));
...
describe('isOwnerOrSudo', () => {
    ...
    it('owner JID matches', async () => {
        expect(await isOwnerOrSudo('917384287404@s.whatsapp.net')).toBe(true);
    });

    it('owner with device suffix matches', async () => {
        expect(await isOwnerOrSudo('917384287404:10@s.whatsapp.net')).toBe(true);
    });
    ...
    it('cleanJid strips device suffix', () => {
        expect(cleanJid('917384287404:10@s.whatsapp.net')).toBe('917384287404');
    });

    it('cleanJid strips @s.whatsapp.net', () => {
        expect(cleanJid('917384287404@s.whatsapp.net')).toBe('917384287404');
    });
