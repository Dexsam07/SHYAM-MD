...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'SHYAM-MD',
    botOwner: process.env.BOT_OWNER || 'Shyam Choudhari',
    ownerNumber: process.env.OWNER_NUMBER || '917384287404',
    author: process.env.AUTHOR || 'dexsam07',
    packname: process.env.PACKNAME || 'SHYAM-MD',
    ...
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/dexsam07/SHYAM-MD/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'dex-shyam-tech',
    // Session
