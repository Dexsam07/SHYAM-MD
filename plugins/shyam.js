...
export default {
    ...
    aliases: ['gaajudl'],
    category: 'download',
    description: 'Download from SHYAM with real-time progress',
    usage: '.gaaju <gaaju-url>',
    async handler(sock, message, args, context) {
        const chatId = context.chatId || message.key.remoteJid;
        const text = args.join(' ').trim();
        if (!text) {
            return sock.sendMessage(chatId, { text: `*Usage:* .shyam https://shyam/file/xxxx#xxxx` }, { quoted: message });
        }
        try {
