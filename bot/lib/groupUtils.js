 ...
 *   - Phone JIDs with device suffix  (91XXXXXXXXX:5@s.whatsapp.net)
 *   - Phone JIDs without device suffix (918XXXXXXXXX@s.whatsapp.net)
...
async function checkPrivilege(sock, chatId, msg, ctx) {
    ...
    // Bare JID = strip device suffix, keep domain  e.g. "91XXXXXXXXX@s.whatsapp.net"
    const bareJid = rawJid.replace(/:[\d]+@/, '@');
    // Numeric part only  e.g. "91XXXXXXXXX"
