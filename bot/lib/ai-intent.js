'use strict';
  ...
  async function runIntent(sock, msg, detected, prefix, ctx) {
      ...
      const simpleRoutes = {
          tiktok:    '../shyam-cmds/download/tiktok.js',
          instagram: '../shyam-cmds/download/instagram.js',
          twitter:   '../shyam-cmds/download/twitter.js',
          spotify:   '../shyam-cmds/download/spotify.js',
          play:      '../shyam-cmds/download/play.js',
          weather:   '../shyam-cmds/utility/weather.js',
          crypto:    '../shyam-cmds/utility/crypto.js',
          currency:  '../shyam-cmds/utility/currency.js',
          translate: '../shyam-cmds/utility/translate.js',
          calc:      '../shyam-cmds/utility/calc.js',
          qr:        '../shyam-cmds/utility/qr.js',
          horoscope: '../shyam-cmds/utility/horoscope.js',
          quote:     '../shyam-cmds/utility/quote.js',
          riddle:    '../shyam-cmds/games/riddle.js',
          compliment:'../shyam-cmds/fun/compliment.js',
          recipe:    '../shyam-cmds/search/recipe.js',
          wiki:      '../shyam-cmds/search/wiki.js',
          github:    '../shyam-cmds/search/github.js',
          country:   '../shyam-cmds/search/country.js',
          movie:     '../shyam-cmds/movie/moviecmds.js',
          news:      '../shyam-cmds/news/newscmds.js',
          '8ball':   '../shyam-cmds/fun/eightball.js',
          imagine:   '../shyam-cmds/ai/imagine.js',
          time:      '../shyam-cmds/utility/worldclock.js',
          tts:       '../shyam-cmds/ai/aitools.js',
      };

      // Sports player
      if (detected.intent === 'player') {
          const mod = require(path.join(__dirname, '../shyam-cmds/sports/sportscmds.js'));
      ...
      if (detected.intent === 'yta') {
          const cmd = require('../shyam-cmds/download/youtube.js');
