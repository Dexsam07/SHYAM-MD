...
module.exports = {
  name: "ai",
  aliases: ["shyam", "shyamAi", "shyamai", "ask"],
  description: "Chat with shyam AI — powered by live bot APIs",
  category: "ai",
